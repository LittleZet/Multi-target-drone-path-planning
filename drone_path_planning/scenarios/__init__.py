...
from drone_path_planning.scenarios.multiple_chasers_multiple_targets_scenario import MultipleChasersMultipleMovingTargetScenario
...
SCENARIOS: Dict[str, Type[Scenario]] = {
    ...
    'multiple-chasers_multiple-moving-target': MultipleChasersMultipleMovingTargetScenario,
}
